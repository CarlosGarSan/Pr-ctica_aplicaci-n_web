...
public class ServletRegistrarArticuloAdmin extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String expresionRegularTalla = "[xsmlXSML]{1,3}";
		...
		String expresionRegularGenero = "[a-zA-Z·ÈÌÛ˙¡…Õ”⁄Ò—\\s]{1,20}";
		...
		String expresionRegularColor = "[a-zA-Z·ÈÌÛ˙¡…Õ”⁄Ò—\\s]{1,20}";
		...
		String expresionRegularCodigo = "[1-9]{1,5}";
		...
		String expresionRegularModa = "[a-zA-Z·ÈÌÛ˙¡…Õ”⁄Ò—\\s]{1,20}";
		...
		String expresionRegularProvedor = "[a-zA-Z·ÈÌÛ˙¡…Õ”⁄Ò—]{1,20}";
		...
		String expresionRegularProcedencia = "[a-zA-Z·ÈÌÛ˙¡…Õ”⁄Ò—]{1,20}";
		...
		Articulo nuevoArticulo = new Articulo(talla, genero,
				color, codigo, moda, provedor, procedencia, imagen);
